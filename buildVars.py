...
addon_info = AddonInfo(
	...
	addon_name='customBrowseMode',
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_('Custom Browse Mode'),
	# Add-on description
	...
	# Author(s)
	addon_author='Noelia Ruiz Martínez <nrm1977@gmail.com>, Ever Solis <disoever@gmail.com>',
	# URL for the add-on documentation support
	addon_url='https://github.com/nvdaes/customBrowseMode',
...
pythonSources: list[str] = ['addon/*.py', 'addon/globalPlugins/customBrowseMode/*.py']
